...
function Modal(props) {
    ...
    if (visible) {
        return (r$2.createElement(Container, { onClick: toggleVisible },
            r$2.createElement(ModalBox, { onClick: noPropag },
                props.color ? (r$2.createElement(ModalCloser, { onClick: toggleVisible, color: props.color })) : (r$2.createElement(ModalCloser, { onClick: toggleVisible })),
                props.children)));
    }
    else {
        return null;
