...
var ModalBox = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    background: white;\n    padding: clamp(20px, 5vh, 50px);\n    border-radius: 8px;\n    box-shadow: 5px 5px 10px rgba(0, 0, 0, 40%);\n    position: relative;\n    display: flex;\n    flex-flow: column nowrap;\n    justify-content: center;\n    align-items: center;\n    gap: 20px;\n"], ["\n    background: white;\n    padding: clamp(20px, 5vh, 50px);\n    border-radius: 8px;\n    box-shadow: 5px 5px 10px rgba(0, 0, 0, 40%);\n    position: relative;\n    display: flex;\n    flex-flow: column nowrap;\n    justify-content: center;\n    align-items: center;\n    gap: 20px;\n"])));
var ModalCloser = styled.div.attrs(function (props) { return ({
    color: props.color
}); })(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    position: absolute;\n    position: absolute;\n    right: 0px;\n    top: 0px;\n    width: 32px;\n    height: 32px;\n    transform: translateX(50%) translateY(-50%);\n    border: 4px solid ", ";\n    background: white;\n    border-radius: 50px;\n    cursor: pointer;\n    &:before,\n    &:after {\n        position: absolute;\n        left: 11px;\n        top: 5px;\n        content: ' ';\n        height: 15px;\n        width: 3px;\n        background-color: ", ";\n    }\n    &:before {\n        transform: rotate(45deg);\n    }\n    &:after {\n        transform: rotate(-45deg);\n    }\n"], ["\n    position: absolute;\n    position: absolute;\n    right: 0px;\n    top: 0px;\n    width: 32px;\n    height: 32px;\n    transform: translateX(50%) translateY(-50%);\n    border: 4px solid ", ";\n    background: white;\n    border-radius: 50px;\n    cursor: pointer;\n    &:before,\n    &:after {\n        position: absolute;\n        left: 11px;\n        top: 5px;\n        content: ' ';\n        height: 15px;\n        width: 3px;\n        background-color: ", ";\n    }\n    &:before {\n        transform: rotate(45deg);\n    }\n    &:after {\n        transform: rotate(-45deg);\n    }\n"])), function (props) { return props.color ? props.color : "black"; }, function (props) { return props.color ? props.color : "black"; });
function Modal(props) {
    var _a = r$2.useState(true), visible = _a[0], setVisible = _a[1];
    var toggleVisible = function () {
        setVisible(!visible);
    };
    // Stop clicking inside the container from closing the modal
    var noPropag = function (e) {
        e.stopPropagation();
    };
    if (visible) {
        return (r__default["default"].createElement(Container, { onClick: toggleVisible },
            r__default["default"].createElement(ModalBox, { onClick: noPropag },
                props.color ? (r__default["default"].createElement(ModalCloser, { onClick: toggleVisible, color: props.color })) : (r__default["default"].createElement(ModalCloser, { onClick: toggleVisible })),
                props.children)));
    }
    else {
        return null;
